...
#ifndef MSI_ASSIG4_MERGESORTIMPROVED_CPP
#define MSI_ASSIG4_MERGESORTIMPROVED_CPP
 ...
 * @param a          		The vector<Comparable> that is to be sorted
 *
 * @param b 						The constant reference array which will be be used for swapping elements in a into proper order.
 *
 ...
 *
 * @param aSize 				a constant int reference of the size of the of 'a', this just saves having to ask over and over.
 */
	template <class Comparable>
...
#endif //MSI_ASSIG4_MERGESORTIMPROVED_CPP
